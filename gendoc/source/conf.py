# -*- coding: utf-8 -*-
#
# tikreg documentation build configuration file, created by
...
project = u'tikreg'
copyright = u'2019, Anwar O. Nunez-Elizalde'
author = u'Anwar O. Nunez-Elizalde'
